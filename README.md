# apify-mcp-server-builder - Claude Code Agent Skill

An Agent Skill **for Claude** (Claude Code / claude.ai). **Target LLM: Claude.**

**→ The skill lives in [`skills/apify-mcp-server-builder/`](skills/apify-mcp-server-builder/).** Copy that folder into your `~/.claude/skills/` directory.
